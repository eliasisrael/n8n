...
export default createAdapter({
  ...
  fieldMappings: [
    ...
    { name: 'Publication window', value: '={{ $json.property_publication_window }}', type: 'object' },
    { name: 'Master contacts', value: '={{ $json.property_master_contacts }}', type: 'array' },
    { name: 'Location', value: '={{ $json.property_location }}' },
    { name: 'Delivery date', value: '={{ $json.property_delivery_date }}', type: 'object' },
    { name: 'Comms type', value: '={{ $json.property_comms_type }}', type: 'array' },
    { name: 'Post-event description', value: '={{ $json.property_post_event_description }}' },
    { name: 'Public?', value: '={{ $json.property_public }}', type: 'boolean' },
    { name: 'Added', value: '={{ $json.property_added }}' },
    { name: 'Sticky', value: '={{ $json.property_sticky }}', type: 'boolean' },
    { name: 'Event name', value: '={{ $json.property_event_name }}' },
    { name: 'WebflowId', value: '={{ $json.property_webflow_id }}' },
    { name: 'Tasks', value: '={{ $json.property_tasks }}', type: 'array' },
