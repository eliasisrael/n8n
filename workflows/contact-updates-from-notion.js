  ...
  'n8n-nodes-base.executeWorkflow',
  {
    ...
    workflowInputs: {
      ...
      value: {
        ...
        ADDRESS: '={{ JSON.stringify({ addr1: $json["Street address"] || "", addr2: $json["Address line 2"] || "", city: $json["City"] || "", state: $json["State"] || "", zip: $json["Postal code"] || "", country: $json["Country"] || "US" }) }}',
        PHONE: '={{ $json.Phone }}',
