...
export default createAdapter({
  ...
  fieldMappings: [
    ...
    { name: 'Thumbnail', value: '={{ $json.property_thumbnail }}', type: 'array' },
    ...
    { name: 'Publication Date', value: '={{ $json.property_publication_date }}', type: 'object' },
    { name: 'Download File', value: '={{ $json.property_download_file }}', type: 'array' },
  ],
});
